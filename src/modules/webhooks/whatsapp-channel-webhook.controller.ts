...
export class WhatsAppChannelWebhookController {
  private readonly logger = new Logger(WhatsAppChannelWebhookController.name);
  ...
  verify(
    ...
    this.logger.warn('WhatsApp webhook verification failed', { mode });
